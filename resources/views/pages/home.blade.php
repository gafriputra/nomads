...
@section('content')
    ...
    <main>
                ...
                <div class="section-popular-travel row justify-content-center">
                    @foreach ($items as $item)                     
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            {{-- dicek apakah gambarnya lebih dr 0, jika iya munculkan cukup gambar yang pertama saja, jika tidak kosongin --}}
                            <div
        ...
        <section class="section-testimonials-heading" id="">
            <div class="container">
                <div class="row">
